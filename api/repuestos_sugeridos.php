...
LEFT JOIN regis_vehic v ON r.veh_compatible = v.modelo OR r.veh_compatible LIKE CONCAT('%', v.marca_vehiculo, '%')
...
$query .= " ORDER BY 
    CASE 
        ...
        WHEN r.veh_compatible LIKE CONCAT('%', (SELECT marca_vehiculo FROM regis_vehic WHERE id = ?), '%') THEN 2
        ELSE 3
    END,
    r.nombre ASC
LIMIT 50";
