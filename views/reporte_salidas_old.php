    ...
    <div class="main-header animate-fade-in mb-4">
        <div class="d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="d-flex gap-2 mt-3 mt-md-0 flex-wrap">
                <a href="../generar_pdf.php?tipo=salidas_repuestos" target="_blank" class="btn btn-danger" title="Exportar Salidas de Repuestos a PDF">
                    <i class="fas fa-file-pdf"></i> PDF Repuestos
                </a>
                <a href="../generar_pdf.php?tipo=salidas_repuestos&formato=excel" class="btn btn-success" title="Exportar Salidas de Repuestos a Excel">
                    <i class="fas fa-file-excel"></i> Excel Repuestos
                </a>
                <a href="../generar_pdf.php?tipo=salidas_vehiculos" target="_blank" class="btn btn-danger" title="Exportar Salidas de Vehículos a PDF">
                    <i class="fas fa-file-pdf"></i> PDF Vehículos
                </a>
                <a href="../generar_pdf.php?tipo=salidas_vehiculos&formato=excel" class="btn btn-success" title="Exportar Salidas de Vehículos a Excel">
                    <i class="fas fa-file-excel"></i> Excel Vehículos
                </a>
