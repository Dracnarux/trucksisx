        ...
        async function openEditModal(alertId) {
            try {
                ...
                if (data.success && data.alert) {
                    ...
                    console.log('Datos de alerta cargados:', alert);
                    ...
                    // Asignar el nombre de la alerta (posicion_llanta)
                    const posicionInput = document.getElementById('edit-posicion');
                    if (posicionInput) {
                        posicionInput.value = alert.posicion_llanta || '';
                        console.log('Nombre de alerta asignado:', alert.posicion_llanta);
                    }
        ...
        <div class="edit-modal-content">
            ...
            <form id="edit-alert-form" onsubmit="event.preventDefault(); saveAlertChanges();">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="edit-posicion" class="form-control" placeholder="Escriba la alerta que quiere editar" required>
                </div>
