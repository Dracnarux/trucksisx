<div class="container mt-4">
   <div class="card shadow-sm mb-4">
       <div class="card-body">
           <h2 class="card-title text-primary"><i class="bi bi-folder-2-open"></i> Reportes de categorias</h2>
           <form method="GET" action="/trucksisx/reportes.php" class="row g-3 align-items-center mb-3">
                 <input type="hidden" name="reporte" value="categorias">
                 <div class="col-auto">
                ...
                <div class="col-auto">
                          <a href="/trucksisx/reportes.php?reporte=categorias" class="btn btn-primary">Reporte total</a>
                </div>
           </form>
           <div class="mb-3">
                        ...
                        <?php if (!empty($categorias)): ?>
                            <?php foreach ($categorias as $cat): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($cat['caracteristicas'] ?? ''); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr>
...
<script>
    document.getElementById('descargar-pdf').onclick = function(e) {
        ...
        let url = '/trucksisx/reportes.php?reporte=descargarCategoriasPDF';
    ...
    document.getElementById('descargar-excel').onclick = function(e) {
        e.preventDefault();
        const nombre = document.getElementById('nombre').value;
        let url = '/trucksisx/reportes.php?reporte=descargarCategoriasExcel';
        if (nombre) url += '&nombre=' + encodeURIComponent(nombre); 
        window.location.href = url;
    };
</script>
